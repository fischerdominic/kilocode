...
export const dict = {
  ...
  "settings.shell.description": "Shell du terminal pour exécuter des commandes. Auto-detect utilise Git Bash sous Windows, zsh/bash sous macOS et $SHELL sous Linux.",
